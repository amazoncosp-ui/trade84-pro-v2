        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://trade84.com/",
              description:
                "Professional P2P crypto trading since 2015 — buy and sell USDT, BTC, ETH with SEPA, Revolut, Wise, PayPal, Payoneer and 20+ payment methods.",
              foundingDate: "2015",
              contactPoint: [
                {
                  "@type": "ContactPoint",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://trade84.com/",
              description:
                "Trusted P2P Trader Since 2015 — Buy & Sell USDT, BTC, ETH with PayPal, Revolut, SEPA, Wise & 20+ Methods",
            }),
          }}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Peer-to-peer cryptocurrency trading service. Buy and sell USDT (TRC20 & ERC20), BTC, ETH and more with 20+ payment methods including SEPA, SEPA Instant, Revolut, Wise, PayPal, Payoneer.",
